...
const Icons = {
  ...
  database: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg>,
  plug: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22v-5"/><path d="M9 8V2"/><path d="M15 8V2"/><path d="M18 8v5a6 6 0 0 1-12 0V8z"/></svg>,
  wrench: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>,
...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Custom CMS solutions that give you full control over your website content.',
      icon: Icons.fileText,
      gradient: 'gradient-2'
    },
    {
      title: 'Customer Relationship Management',
      description: 'CRM systems to help you manage customer interactions and grow your business.',
      icon: Icons.users,
      gradient: 'gradient-3'
    },
    {
      title: 'Database Design & Optimization',
      description: 'Efficient database architectures for optimal performance and scalability.',
      icon: Icons.database,
      gradient: 'gradient-1'
    },
    {
  ...
  return (
    <section id="services" className="services">
      <div className="services-bg">
        <div className="services-gradient gradient-left" />
        <div className="services-gradient gradient-right" />
      </div>
      ...
      <div className="container">
        ...
        >
          <span className="section-badge">
            <span className="badge-icon">{Icons.briefcase}</span>
            What I Do
          </span>
